...
CREATE TABLE IF NOT EXISTS `car_park_location_slot` (
  ...
  `corner_a_x` decimal(10,6) DEFAULT NULL,
  `corner_a_y` decimal(10,6) DEFAULT NULL,
  `corner_b_x` decimal(10,6) DEFAULT NULL,
  `corner_b_y` decimal(10,6) DEFAULT NULL,
  `corner_c_x` decimal(10,6) DEFAULT NULL,
  `corner_c_y` decimal(10,6) DEFAULT NULL,
  `corner_d_x` decimal(10,6) DEFAULT NULL,
  `corner_d_y` decimal(10,6) DEFAULT NULL,
  PRIMARY KEY (`id`),
